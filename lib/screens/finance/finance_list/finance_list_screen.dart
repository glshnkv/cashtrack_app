...
import 'package:cashtrack_app/widgets/icon_container.dart';
                            ...
                            GridView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                ...
                                return GestureDetector(
                                  onTap: () {
                                    context.router.push(FinanceDetailsRoute(finance: _finance));
                                  },
                                  child: AppContainer(
                                    child: Column(
                                      crossAxisAlignment:
                                      ...
                                      return AppContainer(
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            ActionButtonWidget(text: 'Add Income', width: 150, onTap: () {
                                              context.router.push(AddFinanceRoute(finance: _finance));
                                            }),
                                          ],
                                        ),
                                      );
